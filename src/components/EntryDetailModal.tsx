...
import { DictionaryEntry, Sense, FormItem, EgyptianEtymology, InflectionParadigm } from '../types/dictionary';
...
import { X, Copy, Check, ExternalLink, Share2, Sparkles, BookOpen, Volume2, Download, Quote } from 'lucide-react';
...
export const EntryDetailModal: React.FC<EntryDetailModalProps> = ({
  ...
  url = {https://coptic-dictionary.org/entry.py?tla=${entry.xml_id}},
  year = {2026}
}`;
  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', background: 'var(--bg-surface-elevated)', padding: '10px 16px', borderRadius: 'var(--radius-sm)', fontSize: '13px' }}>
