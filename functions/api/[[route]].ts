...
// Inside functions/api/[[route]].ts, Pages automatically mounts at /api
const app = new Hono<{ Bindings: Bindings }>();

// Database metadata & stats -> /api/stats
...
// Comprehensive Search -> /api/search
...
// Single entry detail -> /api/entries/:id
...
// Word collocation network graph -> /api/network/:word
...
// Quick autocomplete suggestions -> /api/suggest
...
// Official Hono Cloudflare Pages export mounted under /api/*
